      ...
      <div className="relative z-10 grid gap-3 grid-cols-12 grid-rows-4 text-left">
        ...
        >
          ...
          <p className="font-light text-ms">
            Each week, mentors went to each school and helped guide the students
            through the FLL Explore Curriculum. Then, 303 went above and beyond
            by making fun FLL-style challenges for the students to accomplish.
            Students are left happy and excited for future FIRST opportunities
            every week.
          </p>
          <p className="font-bold text-3xl mt-6">MSTDC</p>
          <p className="font-light text-ms my-4">
            This past year Team 303 has established 16 new teams that will
            participate in the Middle School Technology Design Challenge(MSTDC).
            Leading up to the challenge, the team mentors the students as they
            design, build, and program.
          </p>
          <p className="font-light text-ms">
            Each week, the team visits the local Middle School, leading students
            through the engineering design process, in various challenges such
            as Sumo and Football Throw. Team 303 helps to host the event at the
            local Middle School. Schools from surrounding districts attend with
        ...
        >
          ...
          <p className="font-light text-ms my-4">
            ...
            different STEAM related activities, such as bridge-building, marble
            runs, and programming challenges.
          </p>
        </motion.div>
        <motion.div
          whileHover={{
        ...
        >
          ...
          <p className="font-light text-ms my-4">
            ...
            school weekly, planning and running several engineering, design, and
            programming activites. The team later expanded on this program,
            reaching out to three schools in their district and starting 28 new
            LEGO robotics teams.
          </p>
        </motion.div>
      </div>
